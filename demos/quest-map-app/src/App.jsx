...
function AppContent() {
  ...
  const [selectedBasemap, setSelectedBasemap] = useState(
    localStorage.getItem("selectedBasemap") ||
      "224f2063899d48e78447157f1273d2ba",
  );
          ...
          <div className="form-container">
            {!state.submitted && (
              <div className="quest-intro">
                <p className="eyebrow">React Gamification Demo</p>
                <h1>Map Quest Sprint</h1>
                <p>
                  Search a place or track your location to unlock local quests,
                  earn badges, and build progress through the app.
                </p>
              </div>
            )}
